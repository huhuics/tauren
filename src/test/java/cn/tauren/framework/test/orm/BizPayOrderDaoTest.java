...
public class BizPayOrderDaoTest {
    ...
    public void testQuery1() throws SQLException {
        ...
        List<BizPayOrder> ret = dao.query(conn, sql, BizPayOrder.class, id);
    ...
    public void testQuery2() throws SQLException {
        ...
        List<BizPayOrder> ret = dao.query(conn, sql, BizPayOrder.class, (Object[]) null);
    ...
    public void testQuery3() throws SQLException {
        ...
        List<Long> ret = dao.query(conn, sql, Long.class, (Object[]) null);
    ...
    public void testInsert() throws SQLException {
        ...
        Long key = dao.insert(conn, sql, Long.class, params);
    ...
    public void testUpdate() throws SQLException {
        ...
        int cnt = dao.update(conn, sql, params);
